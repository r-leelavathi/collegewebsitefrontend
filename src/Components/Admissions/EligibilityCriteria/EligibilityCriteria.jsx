  ...
  return (
    <div className="eligibility-container">
      ...
      <div className="criteria-section">
        <div className="content-with-image left-image">
          <img src="/assets/staticimages/after10th.jpg" alt="Eligibility for Regular Diploma" />
      ...
      <div className="criteria-section">
        <div className="content-with-image right-image">
          <div className="content">
          ...
          <img src="/assets/staticimages/lateralEntry.jpeg" alt="Eligibility for Lateral Entry" />
        </div>
