  ...
  const labs = [
    {
      ...
      description:
        "The Hardware and Networking Lab at our institution offers students hands-on experience in computer hardware and network configuration. Equipped with 40 Computers, advanced tools and high-performance workstations, students can assemble and troubleshoot systems while learning to set up and manage networks using routers and switches. The lab also features the latest networking software, enabling students to gain skills in network security and troubleshooting. This practical environment prepares students for real-world challenges in the hardware and networking field.",
      equipment: "Computers.",
      images: [
        "/assets/department/CS/5.jpg",
        "/assets/department/CS/7.jpg",
        "/assets/department/CS/8.jpg",
        "/assets/department/CS/9.jpg",
        "/assets/department/CS/10.jpg",
        "/assets/department/CS/11.jpg",
        "/assets/department/CS/12.jpg",
        "/assets/department/CS/13.jpg",
      ],
    },
    {
      ...
      equipment: "Computers",
      images: [
        "/assets/department/CS/1.jpg",
        "/assets/department/CS/2.jpg",
        "/assets/department/CS/3.jpg",
        "/assets/department/CS/4.jpg",
      ],
    },
