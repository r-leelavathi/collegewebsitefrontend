...
export const aboutItems = [
  ...
  },
  {
    ...
    content: (
      <ul>
        <li>
          <Link to="/activities/iccForm">Insert</Link>
        </li>
        <li>
          <Link to="/activities/iccTable">Delete/Update</Link>
        </li>
      </ul>
    ),
  },
  {
    title: 'Discipline Monitoring Cell',
    content: (
      <ul>
        <li>
          <Link to="/activities/dmcForm">Insert</Link>
        </li>
        <li>
          <Link to="/activities/dmcTable">Delete/Update</Link>
        </li>
      </ul>
    ),
  },
...
export const activitiesItems = [
  ...
  {
    title: 'Art, Literature & Cultural Club',
    content: (
      <ul>
        <li>
...
export const newsAndAnnouncementsItems = [
  {
...
export const importantLinksItems = [
  {
    title: 'CCTEK',
    content: (
      <ul>
