  ...
  return (
    <div className="header-container">
      <div className="logo-section">
        <img src="/assets/college logo.jpg" alt="College Logo" className="college-logo" />
      </div>
      ...
      <div className="amrith-logo-section">
        <img src="/assets/amrithmahotsavalogo.jpg" alt="Department Logo" className="amrith-logo" />
      </div>
    </div>
  );
};
